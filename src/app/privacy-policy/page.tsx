    ...
    <>
      ...
      <div className="pp-body">
        ...
        <div className="pp-content">
          ...
          <div className="pp-article">
            <h2>第2条（個人情報の収集方法）</h2>
            <p>当方は、ユーザーが本サービスに利用登録をする際に、メールアドレス等の個人情報をお尋ねすることがあります。また、本サービスのご利用にあたりクレジットカード情報の入力をお願いする場合がありますが、カード情報は決済代行会社（Stripe, Inc.）が管理し、当方のサーバーには保存されません。</p>
          </div>
          <div className="pp-article">
          ...
          <div className="pp-article">
            ...
            <ol>
              ...
              <li><strong>Stripe（Stripe, Inc.）</strong>：クレジットカード決済処理のため。氏名・メールアドレス・カード情報等が送信されます。</li>
            </ol>
            <p>上記のうちAnthropic、SendGrid、Stripeは米国に拠点を置く事業者であり、ご利用者様の個人情報は外国にある第三者へ提供されることになります。当方は、これらの外部サービスを利用することにつきあらかじめご同意いただくものとします。各外部サービスのプライバシーポリシーは各社のウェブサイトからご確認ください。入力いただいた情報は、本サービスの提供の目的のみに使用し、第三者への販売は一切行いません。</p>
            <h3>5. 会話内容の確認について</h3>
