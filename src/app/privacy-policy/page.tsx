      ...
      <div className="pp-body">
        ...
        <div className="pp-content">
          ...
          <div className="pp-article">
            ...
            <p>上記のうちAnthropic、Resend、Stripeは米国に拠点を置く事業者であり、ご利用者様の個人情報は外国にある第三者へ提供されることになります。当方は、これらの外部サービスを利用することにつきあらかじめご同意いただくものとします。各外部サービスのプライバシーポリシーは各社のウェブサイトからご確認ください。入力いただいた情報は、本サービスの提供の目的のみに使用し、第三者への販売は一切行いません。</p>
            <h3>5. 会話内容の確認について</h3>
